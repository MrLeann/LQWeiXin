...
#import "LQAnalogDataGenerator.h"

static NSArray *namesArray;//局部的，不提供外界访问的
static NSArray *iconNamesArray;//局部的
static NSArray *messagesArray;//局部的

@implementation LQAnalogDataGenerator
